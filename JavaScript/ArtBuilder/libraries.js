...
/*jshint loopfunc: true */
	...
	var SinglyList = {
		...
		"add": function(value) {
			...
			var node = Node.constructor(value),
	...
	var LayerRules ={
		"constructor" : function(minBot, maxBot, minTop, maxTop, minLeft, maxLeft, minRight, maxRight, height, width){
			this.minBot = minBot;
			this.maxBot = maxBot;
			this.minTop = minTop;
			this.maxTop = maxTop;
	...
	var ImageLibrary = {
		...
		"getLocation": function(imageID){
			return this.image[imageID][1];
		},

		"getAttributes" : function(imageID){
			return this.image[imageID][2];
		}
	};

	var SceneAsset = {
		"constructor": function(imageID, library){
		...
		"setBottom": function(percentageFrom){
			this.bottom = percentageFrom;
		},

		"setTop": function(percentageFrom){
			this.top = percentageFrom;
		},

		"setLeft": function(percentageFrom){
			this.left = percentageFrom;
		},

		"setRight": function(percentageFrom){
			this.right = percentageFrom;
		},

		"setHeight": function(percentageFrom){
			this.height = percentageFrom;
		},

		"setWidth": function(percentageFrom){
	...
	var DNA = {
		...
		"getNumOfImagesInLayer": function(layerID){
			return this.layers[layerID].getNumOfImages();
		},

		"addImageAsset": function(layer, asset){
			this.layers[layer].addImage(asset);
		},

		"generateHeight": function(layer){
			return this.templateRules[layer].height;
		},

		"generateWidth": function(layer){
			return this.templateRules[layer].width;
		},

		"generateTop": function(layer){
			var top = null;
		...
		"generateNewLayer": function(){
			return new Layer();
		},

		"generateNewSceneAsset": function(imageID, dna){
			return new SceneAsset(imageID, dna.library);
		},

		"generateNewDNA": function(child){
